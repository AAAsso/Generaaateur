...
class DoctrineCrudGenerator extends Generator
{
    ...
    public function generate(BundleInterface $bundle, $entity, ClassMetadataInfo $metadata, $format, $routePrefix, $needWriteActions, $forceOverwrite)
    {
        ...
        $this->actions = $needWriteActions ? array('liste', 'detail', 'nouveau', 'editer', 'supprimer') : array('liste', 'detail');
        ...
        $this->generateListeView($dir);

        if (in_array('detail', $this->actions)) {
            $this->generateDetailView($dir);
        }

        if (in_array('nouveau', $this->actions)) {
            $this->generateNouveauView($dir);
        }

        if (in_array('editer', $this->actions)) {
            $this->generateEditerView($dir);
        }
    ...
    /**
     * Generates the liste.html.twig template in the final bundle.
     *
     * @param string $dir The path to the folder that hosts templates in the bundle
     */
    protected function generateListeView($dir)
    {
        $this->renderFile('crud/views/liste.html.twig.twig', $dir.'/liste.html.twig', array(
            'bundle' => $this->bundle->getName(),
            'entity' => $this->entity,
            'entity_pluralized' => $this->entityPluralized,
            'entity_singularized' => $this->entitySingularized,
    ...
    /**
     * Generates the detail.html.twig template in the final bundle.
     *
     * @param string $dir The path to the folder that hosts templates in the bundle
     */
    protected function generateDetailView($dir)
    {
        $this->renderFile('crud/views/detail.html.twig.twig', $dir.'/detail.html.twig', array(
            'bundle' => $this->bundle->getName(),
            'entity' => $this->entity,
            'entity_singularized' => $this->entitySingularized,
            'identifier' => $this->metadata->identifier[0],
    ...
    /**
     * Generates the nouveau.html.twig template in the final bundle.
     *
     * @param string $dir The path to the folder that hosts templates in the bundle
     */
    protected function generateNouveauView($dir)
    {
        $this->renderFile('crud/views/nouveau.html.twig.twig', $dir.'/nouveau.html.twig', array(
            'bundle' => $this->bundle->getName(),
            'entity' => $this->entity,
            'entity_singularized' => $this->entitySingularized,
            'route_prefix' => $this->routePrefix,
    ...
    /**
     * Generates the editer.html.twig template in the final bundle.
     *
     * @param string $dir The path to the folder that hosts templates in the bundle
     */
    protected function generateEditerView($dir)
    {
        $this->renderFile('crud/views/editer.html.twig.twig', $dir.'/editer.html.twig', array(
            'route_prefix' => $this->routePrefix,
            'route_name_prefix' => $this->routeNamePrefix,
            'identifier' => $this->metadata->identifier[0],
            'entity' => $this->entity,
    ...
    /**
     * Returns an array of record actions to generate (editer, detail).
     *
     * @return array
     */
    protected function getRecordActions()
    {
        return array_filter($this->actions, function ($item) {
            return in_array($item, array('detail', 'editer'));
        });
    }
